...
const { MdsCollection, MdsEntry } = require("../lib/mds");

const { abToBuf, abEqual } = require("../lib/utils");
...
describe("Fido2Lib", function() {
  ...
  describe("config", function() {
    ...
    it("throws on bad timeout", function() {
      assert.throws(
        ...
        TypeError,
        "expected timeout to be number, got: foo"
      );
    });
    ...
    it("throws on NaN timeout", function() {
      assert.throws(
        ...
        RangeError,
        "timeout should be zero or positive integer"
      );
    });
    ...
    it("throws on bad rpId", function() {
      assert.throws(
        ...
        TypeError,
        "expected rpId to be string, got: -1"
      );
    });
    ...
    it("throws on bad rpName", function() {
      assert.throws(
        ...
        TypeError,
        "expected rpName to be string, got: -1"
      );
    });
    ...
    it("throws on bad rpIcon", function() {
      assert.throws(
        ...
        TypeError,
        "expected rpIcon to be string, got: -1"
      );
    });
    ...
    it("throws on bad challengeSize", function() {
      assert.throws(
        ...
        TypeError,
        "expected challengeSize to be number, got: foo"
      );
    });
    ...
    it("throws on bad attestation string", function() {
      assert.throws(
        ...
        TypeError,
        "expected attestation to be 'direct', 'indirect', or 'none', got: foo"
      );
    });
    ...
    it("throws on bad attestation type", function() {
      assert.throws(
        ...
        TypeError,
        "expected attestation to be 'direct', 'indirect', or 'none', got: -1"
      );
    });
    ...
    it("throws if authenticatorAttachment isn't platform or cross-platform", function() {
      assert.throws(
        ...
        TypeError,
        "expected authenticatorAttachment to be 'platform', or 'cross-platform', got: bob"
      );
    });
    ...
    it("throws if authenticatorRequireResidentKey is non-boolean", function() {
      assert.throws(
        ...
        TypeError,
        "expected authenticatorRequireResidentKey to be boolean, got: 0"
      );
    });
    ...
    it("throws if authenticatorUserVerification is not required, preferred, or discouraged", function() {
      assert.throws(
        ...
        TypeError,
        "expected authenticatorUserVerification to be 'required', 'preferred', or 'discouraged', got: bob"
      );
    });
    ...
    it("throws on bad cryptoParams", function() {
      assert.throws(
        ...
        TypeError,
        "expected cryptoParams to be Array, got: bob"
      );
    });
    ...
    it("throws on bad value inside cryptoParams", function() {
      assert.throws(
        ...
        TypeError,
        "expected cryptoParam to be number, got: bob"
      );
    });
    ...
    it("throws on empty cryptoParams", function() {
      assert.throws(
        ...
        TypeError,
        "cryptoParams must have at least one element"
      );
    });
  });
  ...
  describe("attestationOptions", function() {
    ...
    it("picks up values from constructors options", function() {
      ...
      return serv.attestationOptions().then(opts => {
        ...
        assert.strictEqual(
          opts.authenticatorSelectionCriteria.attachment,
          "platform"
        );
        assert.isBoolean(
          opts.authenticatorSelectionCriteria.requireResidentKey
        );
        assert.strictEqual(
          opts.authenticatorSelectionCriteria.requireResidentKey,
          false
        ...
        assert.strictEqual(
          opts.authenticatorSelectionCriteria.userVerification,
          "required"
        );
    ...
    it("accepts extraData and returns rawChallenge", async function() {
      ...
      assert.isTrue(
        abEqual(challenge, calculatedChallenge),
        "extraData hashes match"
      );
    });
  });
  ...
  describe("assertionResult", function() {
    ...
    it("valid an assertion", function() {
      ...
      return serv
        .assertionResult(h.lib.assertionResponse, expectations)
        .then(res => {
  ...
  describe("addAttestationFormat", function() {
    ...
    it("adds to map on success", function() {
      ...
      var ret = Fido2Lib.addAttestationFormat(
        "foo",
        function() {},
        function() {}
      );
    ...
    it("throws on bad parseFn", function() {
      assert.throws(
        ...
        TypeError,
        "expected 'parseFn' to be string, got: object"
      );
    });
  ...
  describe("parseAttestation", function() {
    ...
    it("throws if parseFn doesn't return Map", function() {
      assert.throws(
        ...
        Error,
        "foo parseFn did not return a Map"
      );
    });
    ...
    it("throws on missing data", function() {
      assert.throws(
        ...
        TypeError,
        "expected 'attStmt' to be object, got: undefined"
      );
    });
  });
  ...
  describe("createMdsCollection", function() {
    it("throws if no name provided", function() {
      assert.throws(
        ...
        Error,
        "expected 'collectionName' to be non-empty string, got: undefined"
      );
    });
  ...
  describe("findMdsEntry", function() {
    ...
    it("finds a UAF MDS entry in the global collection", async function() {
      ...
      var entryList = Fido2Lib.findMdsEntry(
    ...
    it("throws if id isn't specified", async function() {
      ...
      assert.throws(
        ...
        Error,
        "expected 'id' to be String, got: undefined"
      );
    });
