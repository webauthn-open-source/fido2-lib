  ...
  describe("CertManager", function() {
    ...
    describe("verifyCertChain", function() {
      ...
      it("works for MDS2", function() {
        ...
        var trustedRoots = [new Certificate(h.mds.mdsRootCert)];
      ...
      it("will create certs from input arrays", function() {
        var certs = [h.mds.mdsSigningCert, h.mds.mdsIntermediateCert];
        var trustedRoots = [h.mds.mdsRootCert];

        var certRevocationLists = [h.mds.mdsRootCrl, h.mds.ca1Crl];
