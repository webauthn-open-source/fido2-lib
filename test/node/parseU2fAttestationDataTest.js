...
runs.forEach(function(run) {
	...
	describe(run.functionName + " (fido-u2f)", async function() {
		...
		let ret = run.functionName == "parseAuthnrAttestationResponse" ? await parser[run.functionName](h.lib.makeCredentialAttestationU2fResponse) : await parser[run.functionName](h.lib.makeCredentialAttestationU2fResponse.response.attestationObject);
		...
		it("parses attestation cert", function() {
			...
			assert(h.functions.abEqual(attCert, expectedAttCert), "attCert contains right bytes");
		});
