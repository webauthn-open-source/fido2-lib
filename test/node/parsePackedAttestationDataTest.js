...
runs.forEach(function(run) {
	...
	describe(run.functionName + " (packed)", async function() {
		...
		it("has correct helper", function() {
			assert.equal(typeof h.lib.makeCredentialAttestationPackedResponse, "object");
		});

		let ret = run.functionName == "parseAuthnrAttestationResponse" ? await parser[run.functionName](h.lib.makeCredentialAttestationPackedResponse) : await parser[run.functionName](h.lib.makeCredentialAttestationPackedResponse.response.attestationObject);
		...
		it("has x5c", function() {
			...
			let expectedX5c0 = new Uint8Array([
			...
			let expectedX5c1 = new Uint8Array([
