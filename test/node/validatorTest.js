...
import { coerceToArrayBuffer } from "../../lib/common/utils.js";
...
import * as validator from "../../lib/common/validator.js";
		...
		describe("parsing attestation with " + run.functionName, function() {
			...
			beforeEach(async function() {
				attResp = {
					...
					authnrData: run.functionName == "parseAuthnrAttestationResponse" ? await parser[run.functionName](h.lib.makeCredentialAttestationNoneResponse) : await parser[run.functionName](h.lib.makeCredentialAttestationNoneResponse.response.attestationObject),
				};
