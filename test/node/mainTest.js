...
import { coerceToArrayBuffer, abToBuf, tools, appendBuffer, abEqual } from "../../lib/common/utils.js";
import * as sinon from "sinon";

// Test subject
import { Fido2Lib } from "../../lib/node/main.js";
import { noneAttestation } from "../../lib/common/attestations/none.js";
import { fidoU2fAttestation } from "../../lib/common/attestations/fidoU2F.js";
import { packedAttestation } from "../../lib/common/attestations/packed.js";
import { tpmAttestation } from "../../lib/common/attestations/tpm.js";
import { androidSafetyNetAttestation } from "../../lib/common/attestations/androidSafetyNet.js";
import { packedSelfAttestationResponse } from "../fixtures/packedSelfAttestationData.js";
import { Fido2AssertionResult, Fido2AttestationResult } from "../../lib/common/response.js";
import { MdsCollection, MdsEntry } from "../../lib/common/mds.js";
...
describe("Webauthn", function() {
	...
	describe("attestationOptions", function() {
		...
		it("accepts extraData and returns rawChallenge", async function() {
			...
			let calculatedChallenge = await tools().hashDigest(appendBuffer(opts.rawChallenge,extraData));
			assert.isTrue(abEqual(abToBuf(challenge), abToBuf(calculatedChallenge)), "extraData hashes match");
		});
	});
	...
	describe("addAttestationFormat", function() {
		...
		it("adds to map on success", function() {
			...
			let ret = Fido2Lib.addAttestationFormat("foo", function() {}, function() {});
			assert.isTrue(ret);
	...
	describe("parseAttestation", function() {
		...
		it("returns Map on success", function() {
			...
			let ret = Fido2Lib.parseAttestation("foo", arg);
	...
	describe("validateAttestation", function() {
		...
		it("returns Map on success", async function() {
			...
			let ret = await Fido2Lib.validateAttestation.call(fakeRequest);
			assert.isTrue(ret);
	...
	describe("createMdsCollection", function() {
		...
		it("returns a MdsCollection", function() {
			let mc = Fido2Lib.createMdsCollection("test");
	...
	describe("addMdsCollection", function() {
		...
		it("throws if argument isn't a MdsCollection", function() {
			expect((async function() {
				await Fido2Lib.addMdsCollection();
			})()).to.be.rejectedWith(Error, "expected 'mdsCollection' to be instance of MdsCollection, got: undefined");
		});
		...
		it("can add multiple collections", async function() {
			let mc1 = Fido2Lib.createMdsCollection("fido-mds-1");
			...
			let mc2 = Fido2Lib.createMdsCollection("fido-mds-2");
	...
	describe("findMdsEntry", function() {
		...
		it("finds a UAF MDS entry in the global collection", async function() {
			...
			let entryList = Fido2Lib.findMdsEntry("4e4e#4005");
		...
		it("finds a UAF MDS entry in the global collection", async function() {
			...
			let entryList = Fido2Lib.findMdsEntry("923881fe2f214ee465484371aeb72e97f5a58e0a");
			assert.isArray(entryList);
			assert.strictEqual(entryList.length, 1);
			let entry = entryList[0];
		...
		it("can find multiple entries", async function() {
			...
			let mc1 = Fido2Lib.createMdsCollection("fido-mds1-toc");
			await mc1.addToc(h.mds.mds1TocJwt);
			mc1.addEntry(h.mds.mds1UafEntry4e4e4005);
			await Fido2Lib.addMdsCollection(mc1);

			// Add UAF 4e4e#4005 from FIDO MDS 2
			let mc2 = Fido2Lib.createMdsCollection("fido-mds2-toc");
			await mc2.addToc(h.mds.mds2TocJwt);
			mc2.addEntry(h.mds.mds2UafEntry);
			await Fido2Lib.addMdsCollection(mc2);
