...
import { abEqual, coerceToBase64 } from "../../lib/common/utils.js";
...
runs.forEach(function(run) {
	...
	describe(run.functionName + " (tpm)", function() {
		...
		it("can parse", async function() {
			ret = run.functionName == "parseAuthnrAttestationResponse" ? await parser[run.functionName](h.lib.makeCredentialAttestationTpmResponse) : await parser[run.functionName](h.lib.makeCredentialAttestationTpmResponse.response.attestationObject);
			// console.log("ret", ret);
		});
