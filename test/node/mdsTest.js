...
describe("MdsCollection", function() {
	...
	describe("addToc", function() {
		...
		it("rejects if TOC is junk string", function() {
			// bad toc
			let toc = "sL39APyTmisrjh11vghaqNfuruLQmCfR0c1ryKtaQ81jkEhNa5u9xLTnkibvXC9YpzBLFwWEZ3k9CR_sxzm_pWYbBOtKxeZu9z2GT8b6QW4iQvRlyumCT3oENx_8401r";
		...
		it("rejects if TOC header is missing alg", function() {
			...
			jwtHeader = coerceToBase64Url(strToAb(JSON.stringify(jwtHeader)), "JWT header");
			let jwtBody = "sL39APyTmisrjh11vghaqNfuruLQmCfR0c1ryKtaQ81jkEhNa5u9xLTnkibvXC9YpzBLFwWEZ3k9CR_sxzm_pWYbBOtKxeZu9z2GT8b6QW4iQvRlyumCT3oENx_8401r";
			let jwtSig = "sL39APyTmisrjh11vghaqNfuruLQmCfR0c1ryKtaQ81jkEhNa5u9xLTnkibvXC9YpzBLFwWEZ3k9CR_sxzm_pWYbBOtKxeZu9z2GT8b6QW4iQvRlyumCT3oENx_8401r";
	...
	describe("validate", function() {
		...
		it("throws if no TOC", async function() {
			mc.addEntry(h.mds.mds2UafEntry);
			expect((async function() {
				await mc.validate();
			})()).to.be.rejectedWith(Error, "add MDS TOC before attempting to validate MDS collection");
		});
		...
		it("throws if no entries", async function() {
			...
			expect((async function() {
				mc.validate();
			})()).to.be.rejectedWith(Error, "add MDS entries before attempting to validate MDS collection");
		});
