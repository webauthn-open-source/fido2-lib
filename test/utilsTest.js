...
describe("utils", function() {
  ...
  describe("coerceToBase64Url", () => {
    ...
    it("throws on incompatible: number", () => {
      assert.throws(
        ...
        Error,
        "could not coerce 'test.number' to string"
      );
    });
  ...
  describe("coerceToArrayBuffer", () => {
    ...
    it("throws on incompatible: number", () => {
      assert.throws(
        ...
        Error,
        "could not coerce 'test.number' to ArrayBuffer"
      );
    });
  ...
  describe("str2ab", function() {
    it("converts string to ArrayBuffer", function() {
      ...
      var expectedAb = new Uint8Array([0x61, 0x62, 0x63, 0x31, 0x32, 0x33])
        .buffer;
  ...
  describe("isPem", function() {
    it("detects mdsSigningCert", function() {
      assert.isTrue(
        isPem(h.mds.mdsSigningCert),
        "correctly detects mdsSigningCert"
      );
    });
    ...
    it("detects assnPublicKey", function() {
      assert.isTrue(
        isPem(h.lib.assnPublicKey),
        "correctly detects assnPublicKey"
      );
    });
  ...
  describe("pemToBase64", function() {
    ...
    it(
      ...
      Error,
      "expected PEM string as input"
    );

    it(
      "throws on non-PEM string",
      function() {
        assert.throws(function() {
          pemToBase64("");
        });
