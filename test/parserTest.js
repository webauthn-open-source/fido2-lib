...
describe("parser", function() {
    ...
    describe("parseAttestationObject", function() {
        it("correctly parses 'none' format", function() {
            ...
            var expectedCredId = new Uint8Array([0x00, 0x08, 0xA2, 0xDD, 0x5E, 0xAC, 0x1A, 0x86, 0xA8, 0xCD, 0x6E, 0xD3, 0x6C, 0xD6, 0x98, 0x94,
        ...
        it.skip("correctly parses 'u2f' format", function() {
            ...
            console.log("ret", ret);
            assert.isObject(ret);
            assert.isObject(ret.attStmt);
            assert.strictEqual(ret.fmt, "none");
            assert.instanceOf(ret.authData, Buffer);
            assert(h.functions.bufEqual(ret.authData, h.naked.authDataFromU2f), "authData contains right bytes");
        });
