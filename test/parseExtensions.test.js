		...
		it("correctly parses extension data", async function() {
			const ret = run.functionName == "parseAuthnrAttestationResponse"
				? await parser[run.functionName](
					h.lib.makeExtensionsResponse,
				)
				: await parser[run.functionName](
					h.lib.makeExtensionsResponse.response
						.attestationObject,
				);
			...
			const expectedRawAuthnrData = new Uint8Array([
				...
				0x8F, 0xE4, 0xAE, 0xB9, 0xA2, 0x86, 0x32, 0xC7, 0x99, 0x5C, 0xF3, 0xBA, 0x83, 0x1D, 0x97, 0x63, // hash

				0xC1, // flags (extensions enabled) 0x41

				0x00, 0x00, 0x00, 0x00, // counter

				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
				0x00, 0x00, 0x00, 0x00, 0x00, // aaguid

				0x00, 0xA2, // credIdLength => 21 Bytes

				0x00, 0x08, 0xA2, 0xDD, 0x5E, 0xAC, 0x1A, 0x86, 0xA8, 
				...
				0x52, 0xA2, 0x6C, 0x3A, 0xE2, 0xA6, 0xA6, 0xA5, 0x1C, // credId
				...
				0x11, 0x84, 0xC8, 0x6A, 0xCA, 0xC3, // public key

				0xb9, 0x00, 0x01, 0x6b, 0x63, 0x72, 0x65, 0x64, 0x50, 0x72, 0x6f, 0x74, 0x65, 0x63, 0x74, 0x01, // extensions
			]).buffer;
			
			console.log("------- 1 -------");
			// console.log(">>>>>>>>>>>>>>>>>>>>>>>>", tools.cbor.encode("{credProtect:1}"));
			...
			console.log(">>>>>>>", Buffer.from(rawAuthnrData).toString("hex"));
			console.log("<<<<<<<", Buffer.from(expectedRawAuthnrData).toString("hex"));
			// console.log("++++++++++++++++++++++", Buffer.from("", "hex").toString("base64"));
			// console.log("++++++++++++++++++++++", Buffer.from(rawAuthnrData).toString("hex"));
			// console.log("--------------", Buffer.from(Buffer.from(expectedRawAuthnrData).toString("hex"), "hex").toString("base64"));
			// console.log("<<<<<<<<<<<<<<<<", expectedRawAuthnrData);
