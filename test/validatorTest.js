...
describe("attestation validation", function() {
  beforeEach(function() {
    attResp = {
      request: {},
      requiredExpectations: new Set(["origin", "challenge", "flags"]),
      ...
      authnrData: parser.parseAttestationObject(
  ...
  describe("validateExpectations", function() {
    ...
    it("throws if expectations aren't found", function() {
      ...
      return assert.isRejected(
        ...
        Error,
        "expectations should be of type Map"
      );
    });
    ...
    it("throws if too many expectations", function() {
      ...
      return assert.isRejected(
        attResp.validateExpectations(),
        Error,
        "wrong number of expectations: should have 3 but got 4"
      );
    });
    ...
    it("throws if missing flags", function() {
      ...
      return assert.isRejected(
        attResp.validateExpectations(),
        Error,
        "expectation did not contain value for 'flags'"
      );
    });
    ...
    it("throws if missing origin", function() {
      ...
      return assert.isRejected(
        attResp.validateExpectations(),
        Error,
        "expectation did not contain value for 'origin'"
      );
    });
    ...
    it("throws if challenge is undefined", function() {
      ...
      return assert.isRejected(
        attResp.validateExpectations(),
        Error,
        "expected challenge should be of type String, got: undefined"
      );
    });
    ...
    it("throws if challenge isn't string", function() {
      ...
      return assert.isRejected(
        attResp.validateExpectations(),
        Error,
        "expected challenge should be of type String, got: object"
      );
    });
    ...
    it("throws if challenge isn't base64 encoded string", function() {
      ...
      return assert.isRejected(
        attResp.validateExpectations(),
        Error,
        "expected challenge should be properly encoded base64url String"
      );
    });
    ...
    it("throws on undefined flag", function() {
      ...
      return assert.isRejected(
        attResp.validateExpectations(),
        Error,
        "expected flag unknown: undefined"
      );
    });
  ...
  describe("validateCreateRequest", function() {
    ...
    it("throws if request is undefined", function() {
      ...
      assert.throws(
        ...
        TypeError,
        "expected request to be Object, got undefined"
      );
    });
    ...
    it("throws if response field is undefined", function() {
      ...
      assert.throws(
        ...
        TypeError,
        "expected 'response' field of request to be Object, got undefined"
      );
    });
    ...
    it("throws if response field is non-object", function() {
      ...
      assert.throws(
        ...
        TypeError,
        "expected 'response' field of request to be Object, got number"
      );
    });
    ...
    it("throws if id field is undefined", function() {
      ...
      assert.throws(
        ...
        TypeError,
        "expected 'id' or 'rawId' field of request to be ArrayBuffer, got rawId undefined and id undefined"
      );
    });
    ...
    it("throws if id field is non-string", function() {
      ...
      assert.throws(
        ...
        TypeError,
        "expected 'id' or 'rawId' field of request to be ArrayBuffer, got rawId object and id undefined"
      );
    });
    ...
    it("throws if response.attestationObject is undefined", function() {
      ...
      assert.throws(
        ...
        TypeError,
        "expected 'response.attestationObject' to be base64 String or ArrayBuffer"
      );
    });
    ...
    it("throws if response.clientDataJSON is undefined", function() {
      ...
      assert.throws(
        ...
        TypeError,
        "expected 'response.clientDataJSON' to be base64 String or ArrayBuffer"
      );
    });
  ...
  describe("validateRawClientDataJson", function() {
    ...
    it("throws if missing", function() {
      ...
      return assert.isRejected(
        ...
        Error,
        "clientData clientDataJson should be ArrayBuffer"
      );
    });
  ...
  describe("validateId", function() {
    ...
    it("throws on non-ArrayBuffer", function() {
      ...
      return assert.isRejected(
        attResp.validateId(),
        Error,
        "expected id to be of type ArrayBuffer"
      );
    });
  ...
  describe("validateChallenge", function() {
    ...
    it("throws on three equal signs", function() {
      ...
      return assert.isRejected(
        ...
        Error,
        "clientData challenge was not properly encoded base64url"
      );
    });
    ...
    it("does not remove equal sign from middle of string", function() {
      ...
      attResp.clientData.set(
        "challenge",
        "33EHav-jZ1v9qwH783aU-j0A=Rx6r5o-YHh-wd7C6jPbd7Wh6ytbIZosIIACehwf9-s6hXhySHO-HHUjEwZS29w"
      );
      return assert.isRejected(
        attResp.validateChallenge(),
        Error,
    ...
    it("throws if challenge is not a string", function() {
      ...
      return assert.isRejected(
        attResp.validateChallenge(),
        Error,
        "clientData challenge was not a string"
      );
    });
  ...
  describe("validateAttestation", function() {
    ...
    it("throws on unknown fmt", function() {
      ...
      return assert.isRejected(
        ...
        Error,
        "no support for attestation format: asdf"
      );
    });
  ...
  describe("validateRpIdHash", function() {
    ...
    it("throws when length mismatches", function() {
      ...
      return assert.isRejected(
        attResp.validateRpIdHash(),
        Error,
        "authnrData rpIdHash length mismatch"
      );
    });
  });
  ...
  describe("validateAaguid", function() {
    ...
    it("throws if too short", function() {
      ...
      return assert.isRejected(
        ...
        Error,
        "authnrData AAGUID was wrong length"
      );
    });
  });
  ...
  describe("validateCredId", function() {
    ...
    it("throws if length is undefined", function() {
      ...
      return assert.isRejected(
        ...
        Error,
        "authnrData credIdLen should be number, got undefined"
      );
    });
    ...
    it("throws if length is not number", function() {
      ...
      return assert.isRejected(
        attResp.validateCredId(),
        Error,
        "authnrData credIdLen should be number, got object"
      );
    });
    ...
    it("throws if length is wrong", function() {
      ...
      return assert.isRejected(
        attResp.validateCredId(),
        "authnrData credId was wrong length"
      );
    });
    ...
    it("throws if credId is undefined", function() {
      ...
      return assert.isRejected(
        attResp.validateCredId(),
        "authnrData credId should be ArrayBuffer"
      );
    });
  ...
  describe("validateTokenBinding", function() {
    ...
    it("throws if tokenBinding is defined", function() {
      ...
      return assert.isRejected(
        ...
        Error,
        "Token binding field malformed: foo"
      );
    });
  });
  ...
  describe("validateFlags", function() {
    ...
    it("throws if UP-or-UV and neither is set", function() {
      ...
      return assert.isRejected(
        attResp.validateFlags(),
        Error,
        "expected User Presence (UP) or User Verification (UV) flag to be set and neither was"
      );
    });
  ...
  describe("validateInitialCounter", function() {
    ...
    it("throws if not a number", function() {
      ...
      return assert.isRejected(
        ...
        Error,
        "authnrData counter wasn't a number"
      );
    });
  });
  ...
  describe("validateAudit for 'none' attestation", function() {
    ...
    it("throws on untested verifies", function() {
      return assert.isRejected(
        ...
        Error,
        /^internal audit failed: .* was not validated$/
      );
    });
...
describe("assertion validation", function() {
  ...
  beforeEach(function() {
    ...
    testReq.response.clientDataJSON = h.lib.assertionResponse.response.clientDataJSON.slice(
      0
    );
    testReq.response.authenticatorData = h.lib.assertionResponse.response.authenticatorData.slice(
      0
    );
    testReq.response.signature = h.lib.assertionResponse.response.signature.slice(
      0
    );
    testReq.response.userHandle = h.lib.assertionResponse.response.userHandle.slice(
      0
    );
  ...
  describe("validateAssertionResponse", function() {
    ...
    it("throws if response.signature is undefined", function() {
      ...
      assert.throws(
        ...
        TypeError,
        "expected 'response.signature' to be base64 String or ArrayBuffer"
      );
    });
    ...
    it("throws if response.authenticatorData is undefined", function() {
      ...
      assert.throws(
        ...
        TypeError,
        "expected 'response.authenticatorData' to be base64 String or ArrayBuffer"
      );
    });
    ...
    it("throws if response.userHandle is non-ArrayBuffer & non-String", function() {
      ...
      assert.throws(
        ...
        TypeError,
        "expected 'response.userHandle' to be base64 String, ArrayBuffer, or undefined"
      );
    });
