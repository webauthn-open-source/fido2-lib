...
class Fido2Lib {
    ...
    */
    constructor(opts) {
        ...
        // rpId
        this.config.rpId = opts.rpId || "localhost";
     ...
     * @returns {PublicKeyCredentialCreationOptions} The options for creating calling `credentials.create()`
     */
    async attestationOptions() {
         ...
         * @property {String} rp.name Relying party name (e.g. - "ACME")
         * @property {String} rp.id Relying party ID, a domain name (e.g. - "example.com")
    ...
    async attestationResult(res, expected) {
        ...
        // expectedChallenge, expectedOrigin, expectedFactor
        // {
     ...
     * @returns {PublicKeyCredentialRequestOptions} The options to be passed to `navigator.credentials.get()`
     */
