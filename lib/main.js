...
class Fido2Lib {
    ...
    */
     ...
     * @param {String} expected.rpId The expected rpId that the authenticator has signed over. For example, "localhost" or "webauthn.org"
     * @param {String} expected.origin Deprecated in favor of rpId. The expected origin that the authenticator has signed over. For example, "https://localhost:8443" or "https://webauthn.org"
