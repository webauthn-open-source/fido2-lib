...
function validateId() {
    ...
    if (credId !== undefined && !bufEqual(id, credId)) {
        throw new Error("id and credId were not the same");
    }

    this.audit.journal.add("id");
...
function validateRawAuthnrData() {
    // XXX: this isn't very useful, since this has already been parsed...
...
function validateAttestationSignature() {
...
function validateInitialCounter() {
