...
function validateCreateRequest() {
	...
	if (typeof req.rawId !== "string" &&
		!(req.rawId instanceof ArrayBuffer) &&
		typeof req.id !== "string" &&
		!(req.id instanceof ArrayBuffer)) {
		throw new TypeError("expected 'id' or 'rawId' field of request to be base64 String or ArrayBuffer, got rawId " + typeof req.rawId + " and id " + typeof req.id);
	}
